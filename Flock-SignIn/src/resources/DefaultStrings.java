...
public class DefaultStrings {
	...
	public static final String FLOCK_WEB_PREPROD = "http://updates.flock.co/fl_hydra_web/2.1.0.64/?s=qa&config=preprod";
	public static final String FLOCK_WEB_PROD = "http://updates.flock.co/fl_hydra_web/2.1.0.64/?s=qa&config=prod";
