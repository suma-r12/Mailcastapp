...
public class DefaultStrings {
	...
	public static final String FLOCK_WEB_PREPROD = "updates.flock.co/fl_hydra_web/2.1.0.64/?s=qa&config=preprod";
	public static final String FLOCK_WEB_PROD = "updates.flock.co/fl_hydra_web/2.1.0.64/?s=qa&config=prod";
